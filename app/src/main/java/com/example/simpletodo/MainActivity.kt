...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //set up the button and input field, so the user can enter a task and add to the list
    ...
    // Save the data that the user has inputted by reading and writing from a file
